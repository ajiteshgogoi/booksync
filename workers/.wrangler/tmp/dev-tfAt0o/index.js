...
// .wrangler/tmp/bundle-IA2vrY/middleware-loader.entry.ts
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
init_virtual_unenv_global_polyfill_console();
init_virtual_unenv_global_polyfill_set_immediate();
...
// .wrangler/tmp/bundle-IA2vrY/middleware-insertion-facade.js
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
init_virtual_unenv_global_polyfill_console();
init_virtual_unenv_global_polyfill_set_immediate();
...
async function findKindleHighlightsDatabase(client) {
  if (!client) {
...
var NotionClient = class {
  ...
  async exchangeCodeForToken(code) {
    ...
    try {
      if (!axios_default || typeof axios_default.post !== "function") {
  ...
  async getToken(token) {
    ...
    try {
      ...
      if (tokenData.expires_in) {
        ...
        const expirationTime = receivedAt + tokenData.expires_in * 1e3;
      ...
      console.error("[NotionClient] Failed to get token:", error3);
      throw error3;
    }
  }
